(function() {
  ...
  ace.define('ace/lib/dom', ['require', 'exports', 'module'], function(
    e,
    t,
    n
  ) {
        ...
        (t.getButton = function(e) {
          return e.type == 'dblclick'
            ...
            : e.type == 'contextmenu' ||
              ...
              ? 2
              : e.preventDefault ? e.button : { 1: 0, 2: 2, 4: 1 }[e.button];
        }),
      ...
      var r = e('../lib/event'),
        ...
        f = function(e, t) {
          ...
          var C = function(e) {
              l
                ? (l = !1)
                : E(n) ? (t.selectAll(), b()) : k && b(t.selection.isEmpty());
            },
            k = null;
      ...
      function f(e) {
        ...
        function N(e, n) {
          ...
          var h = e.row != c.row,
            ...
            m = !n || e.row != n.row;
          h || (v && !m)
            ? E ? r - E >= o && t.renderer.scrollCursorIntoView(c) : (E = r)
            : (E = null);
        }
        function C() {
          var e = g;
          ...
          getOption: function(e) {
            ...
            return t
              ? t.forwardTo
                ...
                : t && t.get ? t.get.call(this) : this['$' + e]
            ...
            : e < this.start.row
              ...
              : e > this.end.row
                ...
                : this.start.row === e
                  ...
                  : this.end.row === e ? (t <= this.end.column ? 0 : 1) : 0;
        }),
      ...
      (function() {
        r.implement(this, s),
          ...
          (this.getRange = function() {
            ...
            return this.isEmpty()
              ? o.fromPoints(t, t)
              : this.isBackwards() ? o.fromPoints(t, e) : o.fromPoints(e, t);
          }),
          ...
          (this.getFoldStringAt = function(e, t, n, r) {
            ...
            return (
              ...
              n == -1
                ...
                : n == 1 ? s.substring(t - i.end.column) : s
            );
          }),
          ...
          (this.unfold = function(e, t) {
            ...
            e == null
              ...
              : typeof e == 'number'
                ...
                : 'row' in e ? (n = r.fromPoints(e, e)) : (n = e),
            ...
            for (var o = 0; o < n.length; o++) {
              ...
              if (u == 9) {
                ...
                u == 32
                  ...
                  : (u > 39 && u < 48) || (u > 57 && u < 64)
                    ? i.push(l)
                    : u >= 4352 && m(u) ? i.push(e, t) : i.push(e);
            }
            return i;
          }),
          ...
          wrap: {
            ...
            get: function() {
              return this.getUseWrapMode()
                ? this.$wrap == -1
                  ? 'printMargin'
                  : this.getWrapLimitRange().min ? this.$wrap : 'free'
                : 'off';
            },
            handlesSet: !0
          },
        ...
        r.implement(this, d),
          ...
          (this.startOperation = function(e) {
            ...
            e || ((this.previousCommand = null), (e = {})),
              ...
              this.curOp.command.name && this.$blockScrolling++;
          }),
          (this.endOperation = function(e) {
            if (this.curOp) {
              ...
              t.name && this.$blockScrolling && this.$blockScrolling--;
          ...
          (this.$highlightTags = function() {
            ...
            (this.$highlightTagPending = !0),
              setTimeout(function() {
                ...
                i.type.indexOf('tag-open') != -1 && (i = r.stepForward());
                var s = i.value,
                  o = 0,
                  u = r.stepBackward();
                if (u.value == '<') {
            ...
            if (this.displayIndentGuides) {
              ...
              if (this.showInvisibles) {
                ...
                var u = s.stringRepeat(this.SPACE_CHAR, this.tabSize),
                  a =
                    this.TAB_CHAR + s.stringRepeat('\u00a0', this.tabSize - 1);
              } else
          ...
          (this.setTheme = function(e, t) {
            function o(r) {
              ...
              var s =
                'padding' in r
                  ? r.padding
                  : 'padding' in (n.theme || {}) ? 4 : n.$padding;
            ...
            if (this.inMultiSelectMode && !this.inVirtualSelectionMode) {
              ...
              var r =
                t == this.multiSelect.anchor
                  ? n.cursor == n.start ? n.end : n.start
                  : n.cursor;
              (r.row != t.row ||
