...
CoinAbiDef = [{"constant":false,"type":"function","stateMutability":"nonpayable","inputs":[{"name":"OtaAddr","type":"string"},{"name":"Value","type":"uint256"}],"name":"buyCoinNote","outputs":[{"name":"OtaAddr","type":"string"},{"name":"Value","type":"uint256"}]},{"constant":false,"type":"function","inputs":[{"name":"RingSignedData","type":"string"},{"name":"Value","type":"uint256"}],"name":"refundCoin","outputs":[{"name":"RingSignedData","type":"string"},{"name":"Value","type":"uint256"}]},{"constant":false,"inputs":[],"name":"getCoins","outputs":[{"name":"Value","type":"uint256"}]}];
CoinContractAddr = "0x0000000000000000000000000000000000000006";
CoinContract = web3.eth.contract(CoinAbiDef);
CoinContractInstance = CoinContract.at(CoinContractAddr);
...
StampContractAddr = "0x0000000000000000000000000000000000000006";
StampContract = web3.eth.contract(StampabiDef);
StampContractInstance = StampContract.at(StampContractAddr);
