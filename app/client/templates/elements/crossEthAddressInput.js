...
@class [template] cross_eth_addrInput
@constructor
*/

Template.cross_eth_addrInput.onCreated(function() {
  var template = this;
...
Template.cross_eth_addrInput.onRendered(function() {
  if (this.data) {
    this.$('input').trigger('change');
  }
});

Template.cross_eth_addrInput.helpers({
  /**
...
Template.cross_eth_addrInput.events({
  /**
