...
/**
 ...
 @class [template] views_wethTowan
 @constructor
 */
...
// Set basic variables
Template['views_wethTowan'].onCreated(function(){
    var template = this;
...
Template['views_wethTowan'].onRendered(function(){
    var template = this;
...
Template['views_wethTowan'].helpers({
    'wanBalance': function () {
...
Template['views_wethTowan'].events({
    ...
    'submit form': function(e, template){
        ...
        if(selectedAccount && !TemplateVar.get('sending')) {
            ...
            if(TemplateVar.get('selectType') === '0' && !web3.isAddress(to) && !data)
                return GlobalNotification.warning({
                    content: 'i18n:wallet.send.error.noReceiver',
                    duration: 2
                });
