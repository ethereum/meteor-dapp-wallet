...
// Set basic variables
Template['views_deployContract'].onCreated(function(){
    var template = this;
    ...
    if(FlowRouter.getRouteName() === 'deployContract') {
        ...
        TemplateVar.set('routeName', true);
        ...
        TemplateVar.set('routeName', false);
    }
...
Template['views_deployContract'].onRendered(function(){
    var template = this;
...
Template['views_deployContract'].helpers({
    ...
    'routeName': function () {
        return TemplateVar.get('routeName');
    },
...
Template['views_deployContract'].events({
    /**
     Send all funds
